...
jQuery(document).ready(function(){
  ...
  jQuery("ul.ulNav").superfish() //((jQuery.browser.msie && /6.0/.test(navigator.userAgent)) ? null : {opacity:'show', height:'show' }) })
	.find(">li:has(ul)")
		.mouseover(function(){
            jQuery("ul", this).bgIframe();
		})
		.find("a")
			.focus(function(){
				jQuery("ul", $(".nav>li:has(ul)")).bgIframe();
			});

/*  jQuery("ul.ulNavVertical").superfish({ hoverClass: 'hover' })
	.find(">li:has(ul)")
		.mouseover(function(){
