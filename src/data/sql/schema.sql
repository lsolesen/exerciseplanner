...
CREATE TABLE exercise_images (id INT UNSIGNED AUTO_INCREMENT, exercise_id INT UNSIGNED, filename VARCHAR(200), width MEDIUMINT UNSIGNED, height MEDIUMINT UNSIGNED, INDEX exercise_id_idx (exercise_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE exercise_links (id INT UNSIGNED AUTO_INCREMENT, exercise_id INT UNSIGNED, related_exercise_id INT UNSIGNED, INDEX exercise_id_idx (exercise_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE tag (id INT UNSIGNED AUTO_INCREMENT, name VARCHAR(100), lang VARCHAR(8), is_triple TINYINT(1), triple_namespace VARCHAR(100), triple_key VARCHAR(100), triple_value VARCHAR(100), INDEX name_idx (name), INDEX lang_idx (lang), INDEX triple1_idx (triple_namespace), INDEX triple2_idx (triple_key), INDEX triple3_idx (triple_value), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE tagging (id INT UNSIGNED AUTO_INCREMENT, tag_id INT UNSIGNED NOT NULL, taggable_model VARCHAR(30), taggable_id INT UNSIGNED, INDEX tag_idx (tag_id), INDEX taggable_idx (taggable_model, taggable_id), PRIMARY KEY(id)) ENGINE = INNODB;
